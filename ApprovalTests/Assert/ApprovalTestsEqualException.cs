...
{
    public class ApprovalTestsEqualException : Exception
    {
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="ApprovalTestsEqualException"/> class for string comparisons.
        /// </summary>
        ...
        public ApprovalTestsEqualException(string expected, string actual, int expectedIndex, int actualIndex)
        {
            Actual = actual;
