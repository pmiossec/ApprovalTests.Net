namespace ApprovalTests.Reporters
{
    public class DefaultAssert
    {
        ...
        /// <exception cref="ApprovalTestsEqualException">Thrown when the strings are not equivalent.</exception>
        ...
        public static void Equal(string expected, string actual, bool ignoreCase = false, bool ignoreLineEndingDifferences = false, bool ignoreWhiteSpaceDifferences = false)
        {
            ...
            {
                throw new ApprovalTestsEqualException(expected, actual, expectedIndex, actualIndex);
            }
        }
